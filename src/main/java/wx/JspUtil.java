...
public class JspUtil extends HttpServlet {
	...
	public static String createEnumSelect(WxEnum.Name name, String selName, String initValue, String notSelKey,
			String notSelValue) {
		if (initValue == null)
		...
		if (notSelKey != null && notSelValue != null)
			sb.append("<option value=\"" + notSelKey + "\"" + (initValue.equals(notSelKey) ? "selected" : "") + ">"
					+ notSelValue + "</option>");
		for (Map.Entry<Integer, String> entry : WxEnum.getItems(name).entrySet()) {
